...
- [mysqlclient/MySQLdb documentation](https://mysqlclient.readthedocs.io/user_guide.html#introduction) (please don’t pay attention to _mysql)
- [MySQLdb tutorial](https://www.mikusa.com/python-mysql-docs/index.html)
- [SQLAlchemy tutorial](https://docs.sqlalchemy.org/en/13/orm/tutorial.html)
- [SQLAlchemy](https://docs.sqlalchemy.org/en/13/)
- [mysqlclient/MySQLdb](https://github.com/PyMySQL/mysqlclient)
- [Introduction to SQLAlchemy](https://m.youtube.com/watch?v=woKYyhLCcnU)
- [Flask SQLAlchemy](https://m.youtube.com/playlist?list=PLXmMXHVSvS-BlLA5beNJojJLlpE0PJgCW)
- [10 common stumbling blocks for SQLAlchemy newbies](http://alextechrants.blogspot.com/2013/11/10-common-stumbling-blocks-for.html?m=1)
...
Yes, it’s an [SQL injection](https://en.m.wikipedia.org/wiki/SQL_injection) to delete all records of a table…
...
- `City` class:
    - No change
- `State` class:
    - In addition to previous requirements, the class attribute `cities` must represent a relationship with the class `City`. If the `State` object is deleted, all linked `City` objects must be automatically deleted. Also, the reference from a `City` object to this `State` should be named `state`
- You must use the module `SQLAlchemy`
...
**Solution [101-relationship_states_cities_list.py](101-relationship_states_cities_list.py)**
```
...
**Solution [102-relationship_cities_states_list.py](102-relationship_cities_states_list.py)**
