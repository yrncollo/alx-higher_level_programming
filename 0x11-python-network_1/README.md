...
- [Quickstart with Requests package](https://requests.readthedocs.io/en/latest/user/install/)
...
```
**Solution [0-hbtn_status.py](0-hbtn_status.py)**
...
**Solution [1-hbtn_header.py](1-hbtn_header.py)**
...
**Solution [2-post_email.py](2-post_email.py)**
...
**Solution [3-error_code.py](3-error_code.py)**
...
**Solution [4-hbtn_status.py](4-hbtn_status.py)**
...
**Solution [5-hbtn_header.py](5-hbtn_header.py)**
...
**Solution [6-post_email.py](6-post_email.py)**
...
**Solution [7-error_code.py](7-error_code.py)**
...
**Solution [8-json_api.py](8-json_api.py)**
...
**Solution [10-my_github.py](10-my_github.py)**
...
**Solution [100-github_commits.py](100-github_commits.py)**